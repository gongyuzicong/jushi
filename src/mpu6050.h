 ...
 * ----------------------------------------------------------------------------
 * @description
 * MPU6050是实用性非常强的6轴运动传感器，V1.1版驱动文件只是简单的实现对MPU6050设
...
#define	MPU6050_INT_PIN			GPIOin(GPIOE, 11)	//MPU6050中断脚
...
void MPU6050_LoadConfig(void);	//从EEPROM读取MPU6050配置信息
void MPU6050_WriteConfig(void);	//将配置信息写入EEPROM

extern u8 MPU6050_UPDATE;
