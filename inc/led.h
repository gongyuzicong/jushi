...
#define Warning_LED_NORMAL_STATUS()			{WarningLedCtrlPtr->twinkleFlag = 0; WarningLedCtrlPtr->mode = LED_Twinkle_Count_Enable; Warning_LED_RED_CLEAN(); Warning_LED_GREEN_SET(); Warning_LED_ORANGE_CLEAN(); Warning_LED_GREEN_ON();}
#define Warning_LED_FLMT_SW_ERR_STATUS()	{WarningLedCtrlPtr->twinkleFlag = 1; WarningLedCtrlPtr->mode = LED_Twinkle_Count_Disable; Warning_LED_RED_SET(); Warning_LED_GREEN_CLEAN(); Warning_LED_ORANGE_CLEAN();}
